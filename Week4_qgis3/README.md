...
**Step 11** We've filtered land use for rentals from 2020. Is it still a reliable dataset? Bring in this dataset from the [Syracuse Rental Registry](https://data-syr.opendata.arcgis.com/datasets/4d07491bc81b4d248f22de5da2641021_0/explore?location=43.046710%2C-76.133694%2C13.99) and do a visual comparison. Is there always a 1-to-1 overlap between the rentals from the land use dataset and the rentals from the rental registry? Is the rental registry reliable? ( Hint: Google it.)
